...
import 'package:updown_app/app/models/user.dart';
...
final Map<Type, BaseController> controllers = {
  ...
  StateManagementExampleController: StateManagementExampleController(),
  LocalStorageExampleController: LocalStorageExampleController(),
